    ...
    If Not Intersect(Target, ws.Range("R:R")) Is Nothing Then
        ...
        If Target.Value = "BRASIL - RESOLUX DO BRASIL" Then
            ...
            If colDesc = -1 Then
                ...
                ' Copia formatação da coluna AD para a nova coluna S
                ...
                ' Copia TUDO de B11 para S11:S100 (valor, fórmula, formatação, etc.)
                ws.Range("B11").Copy
            ...
            If colNCM = -1 Then
                ...
                ' Copia formatação da coluna AD para a nova coluna T
                ws.Columns("AD:AD").Copy
                ws.Columns(Target.Column + 2).PasteSpecial Paste:=xlPasteFormats
                Application.CutCopyMode = False
                ws.Cells(10, Target.Column + 2).Value = "NCM"
                
                ' Copia TUDO de B11 para T11:T100 (valor, fórmula, formatação, etc.)
                ws.Range("B11").Copy
